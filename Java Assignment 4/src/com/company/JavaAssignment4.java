...
import com.company.helperClasses.BackDate;
...
public class JavaAssignment4 {
    ...
    public static void main(String[] args) {
        ...
        while(numberOfTests>0) {
            String signupDate = inputScanner.next();
            String currentDayDate = inputScanner.next();
//            System.out.println(signupDate+" "+currentDayDate);
            BackDate backDate=new BackDate(signupDate,currentDayDate);
            backDate.calculateDate();
            numberOfTests--;
        }
    }
}
